...
* TODO Week 11: Visualization III - wordclouds
#+attr_latex: :width 400px
[[../img/chomsky.png]]

*Reading review: "The False Promise of ChatGPT"*
- What's your take on the article?
- Contrast with Gary Marcus/Bill Gates
...
10) How can you display the data structure of a complicated frequency
  ...
  :  $ FREQ: num  2997 1004 781 600 381 ...
    #+end_example
 11) How can you plot a word frequency vector ~foo~:
     #+begin_example R
       > foo <- c("we"=75,"me"=100,"you"=30)
       > foo
...
* TODO Getting the corpus data (again!)
#+attr_latex: :width 300px
#+caption: J.D. Estes at Naval Air Base, Corpus Christi TX (Source: Flickr.com/LOC)
[[../img/torpedoes.jpg]]

- Download ~corpora.R~ from GitHub (bit.ly/corpora)
...
* TODO Week 12: Word clustering and dendograms
* TODO Week 13: N-gram tokenization
* TODO Week 14: Bag-of-words case study
* TODO Week 15: Projects and summary
* References
