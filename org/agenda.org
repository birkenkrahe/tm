...
- [ ] Review DataCamp lesson (40% completed) - what went wrong?
- [ ] Next DataCamp lesson "Cleaning and preprocessing text" (Feb-16)
- [ ] This week: back to "Bag-of-Words" (lecture + practice)
- [ ] Install the ~tm~ package using R on your command line:
  #+begin_example
  c:/User/you> R
